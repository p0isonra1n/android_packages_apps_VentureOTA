...
Venture over the air updates app


License
-------

VentureOTA is licensed under the terms of the *GNU General Public License,
...
VentureOTA allows you to update your VentureROM and your Google Apps.
...
VentureOTA needs to be installed in /system/priv-app to achieve the system
